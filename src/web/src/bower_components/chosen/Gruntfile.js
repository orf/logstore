...
(function() {
  module.exports = function(grunt) {
    ...
    grunt.initConfig({
      ...
      copy: {
        dist: {
          files: [
            {
              cwd: "public",
              src: ["index.html", "index.proto.html", "chosen.jquery.js", "chosen.jquery.min.js", "chosen.proto.js", "chosen.proto.min.js", "chosen.css", "chosen-sprite.png", "chosen-sprite@2x.png"],
              dest: "dist/",
              expand: true,
              flatten: true,
              filter: 'isFile'
            }, {
              src: ["public/docsupport/**"],
              dest: "dist/docsupport/",
              expand: true,
              flatten: true,
              filter: 'isFile'
            }
      ...
      dom_munger: {
        latest_version: {
          ...
          options: {
            callback: function($) {
              return $("#latest-version").text(version_tag());
            }
          }
        }
      },
    ...
    return grunt.registerTask('package_jquery', 'Generate a jquery.json manifest file from package.json', function() {
      var dest, json1, json2, key, pkg, src;
      src = "package.json";
      ...
      return grunt.file.write('chosen.jquery.json', JSON.stringify(json1, null, 2));
    });
  };
